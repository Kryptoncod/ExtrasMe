   ...
   <div style="background-color: #040D2A">
      <div class="form" style="padding : 0; margin : 0; width: 100%; margin:auto;">
         ...
         <div class="container">
            <div class="row">
               <div class="medium-6">
                  <h2 style="letter-spacing:10px; text-transform: uppercase;">@lang('index.contactUs.contactDetails')</h2>
                     <div class="medium-6">
            ...
            <div class="row">
               <div class="columns medium-6" style="padding:0">
                  <h2 style="letter-spacing:10px; text-transform: uppercase;">@lang('index.contactUs.mayeul.title')</h2>
                  <div class="medium-9">
               ...
               <div class="columns medium-6 ">
                  <h2 style="letter-spacing:10px; text-transform: uppercase;">@lang('index.contactUs.paul.title')</h2>
                  <div class="medium-9">
            ...
            <div class="row">
               <div class="col-md-6">
                  <h2 style="letter-spacing:10px; text-transform: uppercase;">@lang('index.contactUs.benjamin.title')</h2>
                  <div class="medium-9">
