    ...
    <div class="medium-10 small-12 columns panel-main">
      ...
      @else
        <div style="width: 70%; display: flex; justify-content:center; flex-direction:column; margin:auto;">
          ...
          <a href="{{ route('modif_files' , Auth::user()->id) }}" style="margin:auto; margin-top: 20px;"><button id="modif-files" style="width:300px;  background-color: #222; padding :10px; ">Modifier mes fichiers importés</button></a>
        </div>
      @endif
