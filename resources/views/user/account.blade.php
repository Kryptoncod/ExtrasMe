        ...
        <div style="display:flex; width: 70%; margin:auto;">
          ...
          <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
            ...
            <label for="name">CATEGORY : </label><select name="category">
                   <option selected disabled value="">{{$professional->category}}</option>
            ...
            <div>
              <label for="email">REFERENCE EMAIL : </label><input type="text" name="email" value="{{$user->email}}" required pattern=".+@ehl.ch$">
              <small class="error">Email is required and must end with @ehl.ch.</small>
            </div>
            <div>
            ...
            <div>
              <label for="number">STATE : </label><input type="text" name="state" value="{{$professional->state}}" required pattern="[1-9]+">
              <small class="error">Sate is required and must be valid</small>
            </div>
            <div>
              <label for="number">COUNTRY : </label><select name="country">
                   <option selected disabled value="">{{$professional->country}}</option>
